...
function SubmitPersonalLeave() {
    ...
    const createPersonalLeave = async (e) => {
        ...
        await addDoc(personalLeaveRef, {ID: empID, Name: empName, StartLeaveDate: startLeave, EndLeaveDate: endLeave, Reason: reason, Status: status, SubmitDate: date});
    ...
    return (
        <div className="bigContainer">
            ...
            <div className="right">
                <h2>Submit Personal Leave Request</h2>
                ...
                <form action="" className="formm">
                    ...
                    <div className="formComponent">
                        <button onClick={createPersonalLeave}>Submit</button>
                    </div>
...
export default SubmitPersonalLeave;