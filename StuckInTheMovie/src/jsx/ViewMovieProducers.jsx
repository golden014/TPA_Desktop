...
function ViewMovieProducers() {

    const partnerState = useSnapCollection(query(collection(db, "MovieProducers")));
...
export default ViewMovieProducers;